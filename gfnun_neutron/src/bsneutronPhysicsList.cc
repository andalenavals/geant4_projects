...
//Hasta aqui ZZZZZZZZZZzzz

        

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

bsneutronPhysicsList::bsneutronPhysicsList()//:  G4VUserPhysicsList()
{
  //  SetVerboseLevel(1);
  defaultCutValue     = 1.0*cm; //Wed Sep  1 20:19:22 COT 2010 was 1*micrometer. but to avoid gammas interactions that
                                //we do not care in this experiment I put it in 1cm...Am I rigth??
  cutForGamma         = defaultCutValue;
  //6 de Octubre.. lo cambie a un rango mas alto para ver si no se producen tantos electrones!
  //cutForElectron      = 1.0*nanometer;
  cutForElectron      = 1.0*cm;
...
bsneutronPhysicsList::~bsneutronPhysicsList()
{
 G4cout << "oooOOOooo Aqui termina bsneutronPhysicsList.cc oooOOOooo"<<G4endl;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void bsneutronPhysicsList::ConstructParticle()
{
  ////Mensaje para mirar donde empieza
  
 G4cout << "oooOOOooo Aqui empieza bsneutronPhysicsList.cc oooOOOooo"<<G4endl;
...
void bsneutronPhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void bsneutronPhysicsList::ConstructLeptons()
{
...
void bsneutronPhysicsList::ConstructHadrons()
{
  //Mesones.....
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void bsneutronPhysicsList::ConstructProcess()
{
  AddTransportation();
...
//Agosto 7..le pue estas lineas que supuestamente hacen falta
// Transportation ///////////////////////////////////////////////////////////
#include "DMXMaxTimeCuts.hh"
#include "DMXMinEkineCuts.hh"
#include "G4StepLimiter.hh"
void bsneutronPhysicsList::AddTransportation() {
...
void bsneutronPhysicsList::ConstructEM() {
...
void bsneutronPhysicsList::ConstructOp() {
...
void bsneutronPhysicsList::ConstructHad() 
{
  //Elastic models                                                                                        
  ...
  const G4double theHPMin =      0.0*eV;
...
void bsneutronPhysicsList::ConstructGeneral() {
...
// Cuts /////////////////////////////////////////////////////////////////////
void bsneutronPhysicsList::SetCuts() 
{
  
  //if (verboseLevel >1)
  // G4cout << "bsneutronPhysicsList::SetCuts:";
