...
MyDigitizerMessenger::MyDigitizerMessenger(MyDigitizer* digitizer) :
	digi(digitizer)
{
...
MyDigitizerMessenger::~MyDigitizerMessenger()
{
	delete pedestalCmd;
	delete noiseCmd;
	delete crosstalkCmd;
...
void MyDigitizerMessenger::SetNewValue(G4UIcommand* cmd,G4String newValue)
{
	if ( cmd == pedestalCmd )
