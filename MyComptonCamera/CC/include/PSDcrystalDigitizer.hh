 ...
 */
class PSDcrystalDigitizer : public G4VDigitizerModule
{
public:
  /*! \brief constructor
   *
   ...
   */
  PSDcrystalDigitizer(G4String aName);

  //! Empty destructor
  virtual ~PSDcrystalDigitizer() {};
...
protected:
   ...
   */
  virtual void MakeCrosstalk(std::vector< std::vector< PSDcrystalDigit* > >& digitsMap);
  //@}
public:
...
private:
  ...
  // PSDcrystalDigitizerMessenger messenger;
