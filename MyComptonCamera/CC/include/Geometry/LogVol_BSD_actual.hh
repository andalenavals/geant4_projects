#ifndef LogVol_BSD_actual_h 
#define LogVol_BSD_actual_h 1
...
\sa Construct()
 */
class LogVol_BSD_actual : public G4LogicalVolume
{
public:
  //! Constructor
  LogVol_BSD_actual(G4String fname="BSD_actual_log",
...
private:
  void ConstructLogVol_BSD_actual(void);
  void SensitiveVolume_BSD_actual(void);
  void SetSolidVol_BSD_actual(void);
...
private:
  ...
  G4VSolid* BSD_actual_solid;
  // Sensitive volume
  G4LogicalVolume* BSD_SensitiveVolume; // optical photons = false
