#ifndef LogVol_PSD_actual_h 
#define LogVol_PSD_actual_h 1
...
\sa Construct()
 */
class LogVol_PSD_actual : public G4LogicalVolume
{
public:
  //! Constructor
  LogVol_PSD_actual(G4String fname="PSD_actual_log",
