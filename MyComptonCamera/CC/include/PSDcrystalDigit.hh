 ...
 */
#ifndef PSDcrystalDigit_h
#define PSDcrystalDigit_h 1
 ...
 * Hits are collected in a collection of hits: \sa PSDcrystalDigitsCollection
 */
class PSDcrystalDigit : public G4VDigi
{
public:
  //! constructor
  PSDcrystalDigit(const int& detector_id);
  //! Empty destructor
  virtual ~PSDcrystalDigit() {}
  /*!
   ...
   */
  inline G4int operator==(const PSDcrystalDigit& aDigi) const
 ...
 */
typedef G4TDigiCollection<PSDcrystalDigit> PSDcrystalDigitsCollection;

/*!
 * \brief Allocator
 *
 * Creating this objects allows for an efficient use of memory.
 * Operators new and delete for the PSDcrystalDigi objects have to be
 * defined
 */
extern G4Allocator<PSDcrystalDigit> PSDcrystalDigitsAllocator;
...
void* PSDcrystalDigit::operator new(size_t)
{
  return static_cast<void*>( PSDcrystalDigitsAllocator.MallocSingle() );
}

void PSDcrystalDigit::operator delete(void* aDigi)
{
  PSDcrystalDigitsAllocator.FreeSingle( static_cast<PSDcrystalDigit*>(aDigi) );
}

#endif /* PSDcrystalDigit_h 1 */
