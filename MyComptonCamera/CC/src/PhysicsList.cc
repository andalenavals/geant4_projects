...
// 
///////////////////////////////////////////////////////////////////////////////////////
//// This physics list was constructed based on /examples/extended/hadronic/Hadr01 ////
///////////////////////////////////////////////////////////////////////////////////////
...
PhysicsList::PhysicsList() 
 : G4VModularPhysicsList(),
   fEmPhysicsList(0), fParticleList(0), fRaddecayList(0), fMessenger(0)
{
  G4LossTableManager::Instance();
  defaultCutValue = 0.7*mm;
  fCutForGamma     = 1.0*mm; /* (10e-6) 10e-2 still produces X-rays but there is no real performance penalty, so on the safe side */
  fCutForElectron  = defaultCutValue;
  fCutForPositron  = defaultCutValue;
  fCutForProton    = 0.00001*mm;
  verboseLevel    = 1;
...
void PhysicsList::ConstructProcess()
{
  ...
  //fRaddecayList->BuildPhysicsTable(fParticleList);
