/**
 * @file BSDcrystalDigit.cc
 * @brief implements BSDcrystalDigit detector output class
 *
...
G4Allocator<BSDcrystalDigit> BSDcrystalDigitsAllocator;

BSDcrystalDigit::BSDcrystalDigit(const int& detector_ID) :
...
bool BSDcrystalDigit::Zero( const G4double& aCharge ,G4bool DoIt)
{
