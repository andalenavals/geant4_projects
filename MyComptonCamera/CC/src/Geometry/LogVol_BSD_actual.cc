/*! @file LogVol_BSD_actual.hh
  @brief Defines mandatory user class LogVol_BSD_actual.
  @date August, 2012
...
LogVol_BSD_actual:: LogVol_BSD_actual(G4String fname,
...
{ 
  ...
  ConstructLogVol_BSD_actual();
  /* Define sensitive volumes*/
  if(detector_flag)
    SensitiveVolume_BSD_actual();
  /* Visualization */
  this->SetVisAttributes(G4VisAttributes::GetInvisible());
}

LogVol_BSD_actual::~LogVol_BSD_actual()
{;}

void LogVol_BSD_actual::ConstructLogVol_BSD_actual(void)
{
  /// Visualization
  ...
  // trick //
  BSD_actual_solid = new G4UnionSolid(Name+"_Solid", solidSpaceCrys1PMT, solidPMT,0,
				      G4ThreeVector(-distance_toPMT,0.,Case_height));
  /*** Main trick here: Set the new solid volume ***/
  SetSolidVol_BSD_actual();
  /////////////////////////////////////////////////////////////
...
void LogVol_BSD_actual::SetSolidVol_BSD_actual(void)
{
  /*** Main trick here:  Set the new solid volume ***/
  if(BSD_actual_solid)
    this->SetSolid(BSD_actual_solid);
}
G4Material* LogVol_BSD_actual::FindMaterial(G4String name) {
  G4Material* material = G4Material::GetMaterial(name,true);
  return material;
}

void LogVol_BSD_actual::SensitiveVolume_BSD_actual()
{
...
void LogVol_BSD_actual::Construct_Crystal_OpFalse(void)
{ }
void LogVol_BSD_actual::Construct_Crystal_OpTrue(void)
{ }
