/*! @file LogVol_PSD_actual.hh
  @brief Defines mandatory user class LogVol_PSD_actual.
  @date August, 2012
...
LogVol_PSD_actual:: LogVol_PSD_actual(G4String fname,
...
{ 
  ...
  ConstructLogVol_PSD_actual();
  /* Define sensitive volumes*/
  if(detector_flag)
    SensitiveVolume_PSD_actual();
   /* Visualization */
  this->SetVisAttributes(G4VisAttributes::GetInvisible());
 }

LogVol_PSD_actual::~LogVol_PSD_actual()
{;}

void LogVol_PSD_actual::ConstructLogVol_PSD_actual(void)
{
  /// Visualization
  ...
  // trick //
  PSD_actual_solid = new G4UnionSolid(Name+"_Solid", Cyl_Outer, Box_Outer,0,
				      G4ThreeVector(0.,0.,Cyl_height+Box_height/2.0));
  /*** Main trick here: Set the new solid volume ***/
  SetSolidVol_PSD_actual();
...
void LogVol_PSD_actual::SetSolidVol_PSD_actual(void)
{
  /*** Main trick here:  Set the new solid volume ***/
  if(PSD_actual_solid)
    this->SetSolid(PSD_actual_solid);
}


void LogVol_PSD_actual::Construct_Crystal_OpFalse(void)
{
...
void LogVol_PSD_actual::Construct_Crystal_OpTrue(void)
{
  /// Visualization
...
G4Material* LogVol_PSD_actual::FindMaterial(G4String name) {
  G4Material* material = G4Material::GetMaterial(name,true);
  return material;
}

void LogVol_PSD_actual::SensitiveVolume_PSD_actual()
{
